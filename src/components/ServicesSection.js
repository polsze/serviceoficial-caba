      ...
      <div className='w-full h-auto py-4'>
        <div className='flex flex-row items-center justify-evenly 2xl:grid 2xl:grid-cols-2 2xl:justify-items-center lg:flex-wrap sm:flex sm:flex-col sm:flex-wrap'>
          <div className="max-w-sm rounded overflow-hidden flex items-center flex-col sm:flex-wrap">
            ...
            <h2 className="font-bold text-xl mb-2 text-center 2xl:text-4xl sm:text-2xl">Nuestro Trabajo Tiene Garantía</h2>
            <p className="text-gray-700 text-lg sm:w-[80%] 2xl:text-3xl sm:text-xl">
          ...
          <div className="max-w-sm rounded overflow-hidden flex items-center flex-col sm:flex-wrap">
            ...
            <h2 className="font-bold text-xl mb-2 text-center 2xl:text-4xl sm:text-2xl">Usamos Repuestos Originales</h2>
            <p className="text-gray-700 text-lg sm:w-[80%] 2xl:text-3xl sm:text-xl">
          ...
          <div className="max-w-sm rounded overflow-hidden flex items-center flex-col sm:flex-wrap">
            ...
            <h2 className="font-bold text-xl mb-2 text-center 2xl:text-4xl  sm:text-2xl">Servicio Residencial y Comercial</h2>
            <p className="text-gray-700 text-lg sm:w-[80%] 2xl:text-3xl sm:text-xl">
          ...
          <div className="max-w-sm rounded overflow-hidden flex items-center flex-col sm:flex-wrap">
            ...
            <h2 className="font-bold text-xl mb-2 text-center 2xl:text-4xl sm:text-2xl">Técnicos Capacitados</h2>
            <p className="text-gray-700 text-lg sm:w-[80%] 2xl:text-3xl sm:text-xl">
