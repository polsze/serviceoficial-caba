...
const FooterSection = () => {
  ...
  return (
    <>
      ...
      <div className='relative right-4 2xl:right-0 xs:right-4 xs:hidden'>
        ...
        <div className=''>
          <ul className='text-black pt- 2xl:pl-8 2xl:pt-4 sm:pt-4 xs:pl-0'>
            ...
            <li className='list-disc sm:text-lg'>Lunes a Viernes: 9:00 a 20:00hs</li>
            <li className='list-disc sm:text-lg'>Sábados: 9:00 a 16:00hs.</li>
      ...
      <div className='h-12 bg-gray-950 text-white flex items-center text-lg justify-center lg:text-center sm:h-16 sm:text-sm sm:px-2 '>
