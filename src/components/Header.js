    ...
    <>
      <header className='flex flex-row overflow-hidden w-full'>
        ...
        <div className="w-full h-32 bg-white flex items-center xs:h-16" >
          <motion.div className="lg:absolute lg:pt-4 lg:-left-20 xs:-left-24 xs:ml-8 xs:pt-8 " initial={{ opacity: 0, x: -250 }} animate={{ opacity: 1, x: 100 }}
          ...
          <div className='fixed right-0 bottom-0 z-10' whileTap={{ scale: 0.9 }}
            >
          ...
          <div className='fixed left-2 bottom-3 z-20 hidden sm:block' whileTap={{ scale: .6 }}
